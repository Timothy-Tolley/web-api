      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', render: function render() {
              return _react2.default.createElement(_Users2.default, { users: _this3.state.users });
            } }),
          _react2.default.createElement(
            _reactRouterDom.Switch,
            null,
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/users/add', render: function render() {
                return _react2.default.createElement(_AddUser2.default, { refresh: _this3.refresh });
              } }),
...
var AddUser = function (_React$Component) {
  ...
  _createClass(AddUser, [{
    ...
    value: function handleClick(e) {
      ...
      _superagent2.default.post('/api/v1/users').set('Content-Type', 'application/json').send({ user: {
